    ...
    try {
        ...
        for (let taskIndex = 0; taskIndex < tasksToGenerate.length; taskIndex++) {
            ...
            if (lowerLabel.includes('vitrier') || lowerLabel.includes('vitrerie') || lowerLabel.includes('vitre') || lowerLabel.includes('vitrage') || lowerLabel.includes('fenêtre') || lowerLabel.includes('fenetre') || lowerLabel.includes('miroir') || lowerLabel.includes('miroiterie')) {
                ...
                negativeConstraint = "\n\n❌ INTERDICTION : AUCUN arbre coupé, AUCUN élagage, AUCUN marteau-piqueur, AUCUNE démolition. Nettoyage basse/haute pression, perche télescopique au sol ou cloche de lavage de sol.";
                ...
                negativeConstraint = "\n\n❌ INTERDICTION : AUCUN arbre, AUCUN sécateur, AUCUN jardinier, AUCUN élagage, AUCUNE grande échelle instable posée sur la pente du toit. Artisans couvreurs sur échafaudage de sécurité ou au sol.";
                ...
                negativeConstraint = "\n\n❌ INTERDICTION : AUCUN élagage d'arbre, AUCUN abattage, AUCUNE dépanneuse, AUCUN terrassement lourd, AUCUN travailleur debout sans protection sur tuiles glissantes. UNIQUEMENT intervention ciblée sur gouttière de rive, chéneau encastré ou tuyau de descente pluviale.";
            }
