  ...
  depannage_auto: {
    ...
    batterie: {
      scenarios: [
        ...
        {
          scene_note:    'battery jump-start with voltage monitoring — portable booster pack connected to battery terminals as primary device; digital multimeter used as secondary instrument to verify voltage recovery during the boost, bonnet open',
          scene_camera:  'close view from above the open engine bay, framing the booster pack on the wheel arch with clamp cables on battery posts and the multimeter beside it as secondary',
          scene_framing: {
            work_pct:   75,
            foreground: 'portable booster pack on the wheel arch, clamp cables running to battery positive and negative terminals — booster LED indicator lit',
            midground:  'digital multimeter resting on the engine bay ledge beside the booster, monitoring voltage — secondary instrument only',
            background: 'open bonnet edge and outdoor surface beyond',
          },
          scene_debris:  'booster carry case open on the ground near the front bumper, multimeter carry pouch beside it',
          scene_exclude: ['jump cables between two cars', 'second vehicle', 'hydraulic jack', 'spare tyre', 'tow strap', 'door wedge', 'multimeter as sole intervention device with no booster or jump cables connected', 'no jump-start device visible', 'technician only measuring voltage with no booster connected'],
          tools: [
            'portable booster pack connected to battery terminals — primary jump-start device',
            'digital multimeter on the engine bay ledge monitoring voltage — secondary instrument only',
          ...
          chantier_details: [
            'portable booster pack clamp cables firmly attached to battery positive and negative posts',
            'booster LED charge indicator lit on the casing — active jump-start in progress',
            'multimeter display visible showing voltage reading beside the booster — secondary monitoring only',
          ],
        },
        {
      ...
      visual_status: 'VISUALLY_VALIDATED',  // batch 2026-07-24: PASS
      ...
      protections: [
        'reflective safety vest on the car roof',
        'reflective warning triangle placed behind the vehicle — optional in private parking, present on public road',
      ],
      chantier_details: [
        'bonnet propped open showing the engine bay',
        'primary jump-start device (booster pack or jump cables) visibly connected to battery terminals — multimeter is secondary only',
        'booster pack clamp cables or jump cables as the main visible action on the battery',
        'empty booster pack carry case on the ground near the front tyre',
        'warning triangle contextual: mandatory on public road, optional in quiet private parking',
      ],
      exclusions: [
        'multimeter-only diagnosis with no booster or jump cables connected',
        'technician only measuring voltage with no active jump-start device',
        'no booster device visible during encours state',
        'floating cables with no clear battery connection',
        'crossed cables on the battery',
        'spectacular sparks at battery terminals',
      ],
    },
    ...
    crevaison: {
      scenarios: [
        {
          scene_note:    'wheel change active phase — camera focused entirely on the side of the vehicle at the active wheel: vehicle hood and engine bay completely outside the camera frame, front of vehicle not visible. One wheel physically absent — exposed wheel hub and brake disc clearly visible in the open wheel arch. Vehicle visibly raised at that corner. Professional hydraulic jack visibly compressed under the reinforced jacking point at the sill. Worker 1 crouched directly beside the exposed hub, hands on a lug wrench or on the wheel being installed. Worker 2 behind and laterally offset from the vehicle, preparing the spare wheel or monitoring cones and warning triangle.',
          scene_camera:  'crouching low beside the active wheel arch — side-on framing showing only the middle section of the vehicle: door, sill, wheel arch, raised tyre gap; front of vehicle and engine bay deliberately out of frame; exposed hub and compressed jack fill the foreground',
          scene_framing: {
            work_pct:   80,
            foreground: 'exposed wheel hub and brake disc fully visible in the open wheel arch — one wheel completely absent; lug wrench and wheel nuts on the ground directly beside the open hub; hydraulic jack compressed under the reinforced sill jacking point — vehicle corner visibly raised',
            midground:  'vehicle door and sill visible; spare wheel on the ground nearby; Worker 1 crouching at the hub with hands on wheel or wrench',
            background: 'Worker 2 in high-visibility vest standing laterally behind the vehicle, preparing spare wheel or watching cones; warning triangle visible in the distance behind the vehicle',
          },
          scene_debris:  'wheel nuts grouped on the ground beside the removed tyre, gravel disturbed around the jack base',
          scene_exclude: [
            'front of vehicle visible',
            'engine bay visible',
            'hood visible in any form — open or closed',
            'bonnet visible',
            'worker positioned at front of vehicle',
            'camera angle showing front bumper or headlights',
            'generic mechanic intervention with no exposed hub',
            'jump cables', 'battery booster', 'tow strap', 'door wedge',
            'engine inspection', 'mixed battery and tire intervention',
            'Worker 2 at the engine bay or under the bonnet',
            'compressor or pressure gauge placed beside tyre with no active repair',
            'equipment arranged for a photo',
            'worker lying under the vehicle supported only by a small jack',
            'person under the vehicle',
            'Worker 2 in the traffic lane',
            'Worker 2 beneath the jacked sill or in the wheel gap zone',
            'jack placed under door sill incorrectly or under body panel',
            'vehicle tilted impossibly',
            'floating wheel with no exposed hub',
            'car resting normally on all four wheels with no visible jack or lift',
          ],
          tools: [
            'hydraulic jack visibly compressed under the reinforced sill jacking point',
            'lug wrench in Worker 1 hands or on the ground beside the hub',
            'spare wheel positioned flat on the ground near the open hub',
          ...
          chantier_details: [
            'camera side-on to the vehicle — vehicle hood and engine bay completely outside the frame',
            'one wheel physically absent — exposed wheel hub and brake disc clearly visible in the open wheel arch',
            'vehicle visibly raised at the active corner — sill gap clearly visible above the compressed jack saddle',
            'professional hydraulic jack visibly compressed under a credible reinforced manufacturer jacking point at the sill',
            'spare wheel positioned flat or upright on the ground near the open hub',
            'lug wrench held by Worker 1 or lying beside the hub',
            'Worker 1 crouched directly beside the exposed hub — hands on wheel or wrench',
            'Worker 2 standing laterally behind or beside the vehicle — preparing spare or monitoring cones',
            'flat tyre leaning against the car body beside the open wheel arch',
            'wheel nuts grouped on the ground near the spare',
            'warning triangle visible behind the vehicle in the distance',
      ...
      scene_note: 'roadside breakdown — flat tyre, tyre change in progress beside a stalled vehicle; hood remains closed throughout — no engine inspection or battery work',
      tools: [
      ...
      protections: [
        'reflective safety vest folded on the car roof',
        'warning cone placed on the road behind the vehicle',
        'warning triangle mandatory on road or roadside',
      ],
      chantier_details: [
        'hood closed throughout the tyre change — engine bay not accessible or visible',
        'Worker 1 (wheel change): crouching or kneeling at the wheel arch, hands on the wheel or wrench',
        'Worker 2 (road safety and spare support): standing laterally at safe distance, placing cones or preparing spare wheel',
      ...
      exclusions: [
        'open hood during tyre change',
        'engine inspection alongside wheel change',
        'mixed battery and tire intervention in same scene',
        'Worker 2 performing engine or battery work',
        'worker beneath the vehicle',
        'jack placed under door sill incorrectly',
        'floating wheel with no visible jack or lift',
      ],
      visual_status: 'NEEDS_VISUAL_RETEST',  // batch 2026-07-24: hood still appeared; sc1 now side-on frame excluding front of vehicle
    },

    remorquage: {
      scenarios: [
        {
          scene_note:    'bright overcast daytime — vehicle already centered and stationary on the horizontal flatbed, winching phase complete; workers now securing the vehicle with wheel ratchet straps. One complete integrated flatbed recovery truck: cab, chassis and flatbed deck physically connected and aligned. Recovered vehicle hood fully closed. Worker 1 crouching at the front of the flatbed, tightening a ratchet strap over the front tyre. Worker 2 at the rear of the flatbed on the opposite lateral side, tightening a ratchet strap over the rear tyre — outside traffic lane and vehicle movement path. Two clearly visible ratchet wheel straps: one passing over a front tyre and connected to a front flatbed anchor point; one passing over a rear tyre and connected to a rear flatbed anchor point. Winch present at the front of the flatbed but cable fully reeled in — no tensioned cable crossing the scene.',
          scene_camera:  'standing at a diagonal beside the integrated recovery truck in bright overcast daytime, framing the full flatbed deck with the secured car on top — clear visibility of both ratchet straps over front and rear tyres, both workers tightening straps from opposite sides; no cable crosses the scene',
          scene_framing: {
            work_pct:   75,
            foreground: 'ratchet strap passing over front car tyre on the flatbed deck — strap visibly taut, connected to a flatbed anchor point; Worker 1 crouching and tightening the strap handle',
            midground:  'recovered car centered on the flatbed deck, hood fully closed, all four tyres resting on the deck; ratchet strap over rear tyre visible on the opposite side — Worker 2 tightening it',
            background: 'truck cab visible ahead, continuous chassis in bright overcast daylight; warning triangle on the road behind the truck',
          },
          scene_debris:  'ratchet strap carry bag on the road beside the truck, empty wheel chock on the deck near a tyre',
          scene_exclude: [
            'nighttime scene',
            'dusk or dawn lighting',
            'artificial emergency lighting as primary illumination',
            'dark sky or night background',
            'standalone trailer or separate flatbed platform not physically attached to any truck cab',
            'truck cab and flatbed pointing in different directions or misaligned',
            'floating or disconnected platform with no visible chassis connection to the cab',
            'tow strap between two cars on flat road with no flatbed',
            'jump cables', 'battery booster', 'door wedge', 'spare tyre',
            'tensioned winch cable crossing the scene or attached to the vehicle',
            'loose cable visible beside the vehicle on the deck',
            'cable held or touched by any worker',
            'open hood on the recovered vehicle',
            'fewer than two ratchet wheel straps visible',
            'ratchet straps not passing over tyre tread',
            'Worker 2 in front of the vehicle or in the traffic lane',
            'Worker 2 in the winch cable trajectory',
            'unsecured vehicle on the deck with no ratchet straps',
          ],
          tools: [
            'ratchet strap taut over front car tyre — strap connected to flatbed anchor point, Worker 1 tightening the ratchet handle',
            'ratchet strap taut over rear car tyre — strap connected to flatbed anchor point, Worker 2 tightening from opposite side',
            'winch visible at the front of the flatbed with cable fully reeled in — no tensioned cable in scene',
          ],
          protections: [
            'reflective safety vest on Worker 1 at the front flatbed strap',
            'reflective safety vest on Worker 2 at the rear flatbed strap',
            'warning triangle placed on the road at credible distance upstream from the operation',
            'warning cone placed on the road behind the recovery truck',
          ],
          chantier_details: [
            'bright overcast daytime — no night, no dusk, no artificial emergency lighting as primary illumination',
            'one complete integrated flatbed recovery truck — cab, chassis and flatbed deck aligned on a single longitudinal axis',
            'recovered vehicle already centered and stationary on the horizontal flatbed deck — winching phase complete',
            'recovered vehicle hood fully closed — engine bay not visible',
            'ratchet strap visibly taut over front car tyre, connected to flatbed front anchor point',
            'ratchet strap visibly taut over rear car tyre, connected to flatbed rear anchor point',
            'two clearly visible ratchet wheel straps — one front, one rear',
            'Worker 1 crouching at the front of the flatbed, tightening the front ratchet strap',
            'Worker 2 at the rear of the flatbed on the opposite lateral side, tightening the rear ratchet strap — outside traffic lane',
            'winch visible at the front of the flatbed — cable fully reeled in, no tensioned cable crossing the scene',
          ],
        },
        {
      ...
      scene_note: 'roadside recovery — vehicle being towed by an integrated flatbed recovery truck or connected via tow strap; warning triangle mandatory on road or roadside; no standalone trailer or disconnected platform',
      tools: [
      ...
      protections: [
        ...
        'warning triangle mandatory on road or roadside — placed at credible upstream distance',
        'warning cone placed on the road behind the stalled vehicle',
      ],
      chantier_details: [
        'recovery truck or flatbed physically connected to the stalled vehicle — no floating or disconnected platform',
        'tow strap running between the two vehicles at low angle, or ratchet straps securing vehicle to flatbed',
        'recovery hook visible under the stalled vehicle front bumper',
        'warning triangle placed on the road at credible distance upstream from the scene',
        'open recovery truck visible with chassis and deck aligned',
      ],
      exclusions: [
        'standalone trailer presented as integrated flatbed with no truck cab connected',
        'separate van beside an unrelated flatbed platform',
        'platform floating with no chassis connection to the recovery truck',
        'truck cab and flatbed pointing in different directions',
        'cable with no visible origin on the recovery truck',
        'cable with no visible attachment point on the recovered vehicle',
        'unsecured vehicle on deck with no wheel restraints or ratchet straps',
        'Worker 2 in cable recoil zone or directly in front of or behind moving vehicle',
      ],
      visual_status: 'NEEDS_VISUAL_RETEST',  // batch 2026-07-24: nighttime generated despite exclusion; sc1 now strap-securing phase in bright overcast daytime, no winch cable
    },
    ...
    ouverture: {
      ...
      scene_note: 'roadside lockout — vehicle door opening in progress, technician working at the door frame with non-destructive specialist tools; vehicle and bodywork intact; warning triangle optional at private home or quiet driveway',
      tools: [
      ...
      chantier_details: [
        ...
        'keys or key fob visible inside the car through the window',
        'service van parked naturally beside or behind the customer vehicle — rear doors and cargo shelves physically coherent, ordinary locksmith tools stored inside',
        'warning triangle optional at private driveway or home — not forced in a residential setting',
      ],
      exclusions: [
        'broken window',
        'crowbar or forced-entry tool',
        'damaged bodywork from forced entry',
        'violent or destructive door opening',
        'scene resembling vehicle theft or break-in',
        'distorted van shelves or impossible open rear van structure',
        'heavy roadside balisage in a private driveway or home setting',
      ],
      visual_status: 'VISUALLY_VALIDATED',  // batch 2026-07-24: PASS
    },
