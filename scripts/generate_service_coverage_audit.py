...
BEFORE_FIX = {
    ...
    # Cluster toiture/étanchéité/nettoyage_toiture/gouttières — wave 2 (feat/roof-waterproofing-gutter-scenes)
    ('nettoyage_toiture',  'Nettoyage toiture'):           'PARTIAL_CONTEXTE',
    ('etancheite',         'Réparation fuite toiture'):    'PARTIAL_CONTEXTE',
    ('etancheite',         'Recherche de fuite'):          'PARTIAL_CONTEXTE',
    ('etancheite',         'Infiltration toiture'):        'PARTIAL_CONTEXTE',
    ('etancheite',         'Étanchéité toit terrasse'):    'PARTIAL_CONTEXTE',
    ('etancheite',         'Étanchéité toiture plate'):    'PARTIAL_CONTEXTE',
    ('etancheite',         'Étanchéité balcon'):           'PARTIAL_CONTEXTE',
    ('etancheite',         'Étanchéité terrasse'):         'PARTIAL_CONTEXTE',
    ('etancheite',         'Étanchéité EPDM'):             'PARTIAL_CONTEXTE',
    ('etancheite',         'Étanchéité PVC'):              'PARTIAL_CONTEXTE',
    ('etancheite',         'Étanchéité bitume'):           'PARTIAL_CONTEXTE',
    ('etancheite',         "Réfection d'étanchéité"):      'PARTIAL_CONTEXTE',
    ('etancheite',         'Étanchéité acrotère'):         'PARTIAL_CONTEXTE',
}
AFTER_FIX = {
    ...
    # Cluster toiture/étanchéité/nettoyage_toiture/gouttières — wave 2 (feat/roof-waterproofing-gutter-scenes)
    ('nettoyage_toiture',  'Nettoyage toiture'):           'ROUTED_TO_SPECIFIC_SCENE',
    ('etancheite',         'Réparation fuite toiture'):    'ROUTED_TO_SPECIFIC_SCENE',
    ('etancheite',         'Recherche de fuite'):          'ROUTED_TO_SPECIFIC_SCENE',
    ('etancheite',         'Infiltration toiture'):        'ROUTED_TO_SPECIFIC_SCENE',
    ('etancheite',         'Étanchéité toit terrasse'):    'ROUTED_TO_SPECIFIC_SCENE',
    ('etancheite',         'Étanchéité toiture plate'):    'ROUTED_TO_SPECIFIC_SCENE',
    ('etancheite',         'Étanchéité balcon'):           'ROUTED_TO_SPECIFIC_SCENE',
    ('etancheite',         'Étanchéité terrasse'):         'ROUTED_TO_SPECIFIC_SCENE',
    ('etancheite',         'Étanchéité EPDM'):             'ROUTED_TO_SPECIFIC_SCENE',
    ('etancheite',         'Étanchéité PVC'):              'ROUTED_TO_SPECIFIC_SCENE',
    ('etancheite',         'Étanchéité bitume'):           'ROUTED_TO_SPECIFIC_SCENE',
    ('etancheite',         "Réfection d'étanchéité"):      'ROUTED_TO_SPECIFIC_SCENE',
    ('etancheite',         'Étanchéité acrotère'):         'ROUTED_TO_SPECIFIC_SCENE',
}
