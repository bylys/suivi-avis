...
const VISUAL_RULES_BY_SERVICE = {
  ...
  'Terrassement': `VISUAL: Earthworks with yellow compact mini-excavator (mini-pelle) digging or moving soil, laser level tripod standing on side, ground worker with shovel or grade rod, freshly excavated ground.`,
  'Nivellement de Terrain': `VISUAL: Land leveling and grading. Mini-excavator with tilt grading bucket (godet de nivellement) smoothing topsoil, ground worker using laser level receiver staff, flat graded earth surface prepared for lawn or construction.`,
  'VRD': `VISUAL: VRD utility trenches (Voirie et Réseaux Divers). Open trench with color-coded utility sheaths (blue for water, yellow for gas, red for electric, green for telecom) laid neatly on sand bed by ground workers, mini-excavator in background.`,
  'Viabilisation de terrain': `VISUAL: Plot serviced with utilities (viabilisation). Deep utility trench connecting property boundary to street, PVC pipes and utility conduit sheaths visible, ground workers in safety vests checking connections.`,
  'Assainissement Individuel': `VISUAL: Individual sanitation installation. Large excavation pit with all-water septic tank (fosse toutes eaux) or compact micro-station being positioned, PVC drainage pipes connecting into inlet.`,
  'Raccordement': `VISUAL: Utility connection trench. Workers connecting PVC sewer pipes or municipal water supply line into street utility pit/manhole, laser level and gravel bedding visible.`,
  'Fondations': `VISUAL: Strip foundation trenches (fouilles en rigole pour fondations de maison). Clean trench excavated into solid ground with steel rebar cages (armatures de semelles filantes) placed inside, ready for concrete pouring.`,
  'Drainage': `VISUAL: Foundation perimeter drainage. Trench dug around house foundation wall, yellow perforated drainage pipe (drain agricole/bâtiment) laid at bottom over geotextile fabric and covered with crushed drainage gravel.`,
  'Voie d\'accès, allées et Parking': `VISUAL: Driveway and parking sub-base preparation. Decaissement (soil excavation), white geotextile membrane spread across driveway, heavy layer of crushed gravel (grave tout-venant) being leveled and compacted by plate compactor or roller.`,
  'Murs de soutènement': `VISUAL: Retaining wall construction for soil slope. Heavy precast interlocking concrete blocks, hollow blocks with rebar, or gabion wire cages filled with crushed quarry stones built against an earth bank.`,
  'Enrochement': `VISUAL: Heavy rock armour / riprap retaining embankment (enrochement de talus). Tracked excavator equipped with stone grab bucket or heavy bucket carefully placing large quarry boulders (blocs de roches massives) along steep slope.`,
  'Terrassement pour piscine': `VISUAL: Swimming pool excavation. Precise rectangular or custom-shaped deep excavation hole dug in residential garden by mini-excavator, neatly leveled floor base with crushed gravel, dump truck loading excess soil.`,
