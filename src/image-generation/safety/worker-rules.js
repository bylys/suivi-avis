...
const WORKER_SCENE_RULES = {
  ...
  nettoyage_gouttieres: {
    ...
    actions: [
      'worker scooping compacted leaf debris from the gutter trough at the top of a ladder with standoff stabiliser — below the highest safe rungs',
      'worker cleaning the gutter trough from a ladder with standoff, using a small gutter scoop into a bucket attached to the rung',
      'worker inserting a compact flexible clearing tool into the blocked gutter-to-downpipe junction from a ladder with standoff',
    ],
    postures: [
      'worker at the top of an extending ladder with standoff, both forearms at gutter-trough level, using gutter scoop — back to camera',
      'worker on ladder below the highest safe rungs, one hand on the rung for stability, other hand working the scoop — in profile',
    ],
    access: ['professional extension ladder with standoff stabiliser footed on firm level ground — standoff arms braced on wall below eave, gutter trough clear of ladder rails', 'MEWP basket positioned beside the gutter (remplacement/pose only)'],
    safety_required: [
      'ladder with visible standoff stabiliser — arms braced on wall below the eave, NOT on the gutter',
    ...
    forbidden: [
      ...
      'person standing directly below the active falling-debris zone',
      'person reaching far sideways off the ladder',
      'standing on the top two rungs of the ladder',
      'both hands occupied with no stable contact point',
      ...
      'second worker artificially added for nettoyage or débouchage',
    ],
    presence_indirect: [
