...
export const SITE_REALISM_ROOF = {
  ...
  nettoyage_toiture: {
    scenarios: [
      ...
      {
        _for:          'anti.mousse',
        scene_note:    'homeowner photo from the garden showing the full mossy roof slope immediately after anti-moss biocide application — two professionals in mid-operation view: Worker 1 still positioned on the secured hooked roof ladder (hooks over the ridge, NOT resting on the gutter) — harness lanyard visible connected to ridge anchor — roof surface still fully covered with green and black moss, overlapping irregular damp patches visible across the treated areas — no clean-versus-dirty boundary — photo taken from the garden or driveway at a natural distance capturing the full extent of the treatment area',
        scene_camera:  'ordinary homeowner smartphone from the garden or driveway, 10–16 m from the house, looking up at the full pitched roof slope — wide enough framing to show the complete moss-covered surface and the workers in context — mild digital zoom, slightly imperfect angle — customer-accessible ground-level viewpoint',
        scene_framing: {
          work_pct:   45,
          foreground: 'garden or driveway at the foot of the house — protective tarp visible below the eave edge — Worker 2 at the ladder foot managing the product hose, outside the falling-material zone',
          midground:  'full pitched roof slope — green and black moss blanketing the full tile surface — overlapping irregular damp patches showing where biocide has been applied, feathered and uneven edges, no clean straight boundary — Worker 1 on secured hooked roof ladder (hooks over ridge visible), harness lanyard leading to ridge anchor',
          background: 'ridge line, pale sky, neighbouring rooftops or treetops',
        },
        scene_debris:  'no scraped or removed moss — biological growth intact across the full slope, slight biocide drips on the lower tarp fold',
        scene_exclude: [
          'worker standing directly on wet moss-covered tiles without secured access',
          'single worker performing active roof treatment alone',
          'backpack sprayer as sole apparent safety equipment with no harness or anchor visible',
          'worker on mossy roof without connected fall arrest',
          'clean roof tiles visible alongside mossy area',
          'instant moss disappearance or clean strip result',
          'perfectly straight clean-versus-dirty boundary across the slope',
        ...
        protections: [
          'secured hooked roof ladder with hooks over the ridge — visible from garden distance',
          'fall-arrest harness and connected lanyard visible on Worker 1',
          'protective tarp below the eave edge catching any biocide runoff',
          'Worker 2 at ladder foot outside falling-material zone',
        ],
        chantier_details: [
          'full pitched roof slope still entirely mossy — green and black biological growth dominant',
          'overlapping irregular damp patches across the treated area — feathered, uneven, no clean boundary',
          'biocide applied — moss still intact, treatment takes days to weeks to act visibly',
          'wide framing shows the full extent of treatment and both workers in context',
        ],
      },
