    ...
    try {
        ...
        for (let taskIndex = 0; taskIndex < tasksToGenerate.length; taskIndex++) {
            ...
            if (lowerLabel.includes('démoussage') || lowerLabel.includes('nettoyage') || lowerLabel.includes('façade') || lowerLabel.includes('terrasse')) {
                ...
                negativeConstraint = "\n\n❌ ABSOLUTE PROHIBITION: NO giant tall extension ladders leaning against the front of the house reaching up the roof slope, NO single worker climbing a giant ladder in front of a house, NO hedge trimming, NO tree surgeons, NO pressure washing patio, NO tow trucks, NO arborists. ONLY roofing work on scaffolding or hooked roof ladder laid flat on tiles.";
