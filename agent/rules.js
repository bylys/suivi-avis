...
const SAFETY_RULES = {
  toiture: `SAFETY RULES — Roofing: Minimum 2 workers visible. WORKER LOCATION: Workers MUST be either (A) on a low mobile scaffolding / scaffold tower, OR (B) working on a roof ladder laid flat along the roof slope, OR (C) working on eaves/gutter level from a standard ladder resting against the gutter edge. ABSOLUTE PROHIBITION: NO giant tall extension ladder leaning against the middle of the house reaching up to the roof slope! NO loose stacks of tiles floating floating or stacked unrealistically on open laths. Tiles must be neatly aligned or stored in secure roof buckets. Connected safety harness is MANDATORY on roof slope. Worker 2: at ground level or holding ladder base.`,
  ...
  elagage: `SAFETY RULES — Tree pruning & Woodwork: MANDATORY SAFETY GLASSES / PROTECTIVE GOGGLES on all workers' faces (eye protection mandatory against flying wood chips). Minimum 2 workers (1 climber in tree, 1 ground assistant). Climber: arborist helmet with chinstrap + climbing harness + ropes visible and anchored to main tree fork. Ground assistant: helmet + high-vis vest, standing outside fall zone. NEVER: person in fall zone of branch being cut, ladder floating mid-air without branch support.`,
...
const VISUAL_RULES_BY_SERVICE = {
  ...
  'Taille arbre haute tige': `VISUAL: MANDATORY SAFETY GLASSES on climber and assistant. Climbing harness + ropes anchored to main crotch. If a ladder is present, it must reach a solid main fork or be omitted. Realistic human-to-tree scale mandatory.`,
  'Elagage arbre': `VISUAL: MANDATORY SAFETY GLASSES on climber and assistant. Climbing harness + ropes visible and anchored to main crotch. If an aluminum ladder is shown, it must rest securely against a main branch fork, NEVER stopping awkwardly mid-trunk far below the worker.`,
  'Elalgage en hauteur': `VISUAL: MANDATORY SAFETY GLASSES on climber and assistant. Climbing harness + ropes visible and anchored to main crotch. If an aluminum ladder is shown, it must rest securely against a main branch fork, NEVER stopping awkwardly mid-trunk far below the worker.`,
  'Reparation toiture': `VISUAL: Fully tiled roof surface in clean, finished condition. Roofers replacing 1 or 2 targeted damaged terracotta roof tiles, flat roof-ladder hooked on ridge, minimum 2 workers (1 on roof with harness, 1 at ground). ABSOLUTE PROHIBITION: NO exposed bare wooden laths/battens! NO skeletal uncovered roof structure! The roof must be 95%+ fully covered with terracotta tiles.`,
  'Renovation tuiles toiture': `VISUAL: Fully tiled roof surface in clean, finished condition. Roofers performing ridge or edge tile maintenance. ABSOLUTE PROHIBITION: NO exposed bare wooden laths/battens! NO skeletal uncovered roof structure! The roof must be 95%+ fully covered with terracotta tiles.`,
  'Changement tuiles': `VISUAL: Fully tiled roof surface in clean, finished condition. Roofers on flat roof-ladder replacing targeted broken tiles, neatly laid terracotta tiles in clean aligned rows. ABSOLUTE PROHIBITION: NO exposed bare wooden laths/battens! NO skeletal uncovered roof structure!`,
  'Reparation tuiles': `VISUAL: Fully tiled roof surface in clean, finished condition. Roofers on flat roof-ladder replacing targeted broken tiles, neatly laid terracotta tiles in clean aligned rows. ABSOLUTE PROHIBITION: NO exposed bare wooden laths/battens! NO skeletal uncovered roof structure!`,
  'Remplacement tuiles': `VISUAL: Fully tiled roof surface in clean, finished condition. Roofers replacing broken terracotta roof tiles on slope, replacement tiles laid in realistic parallel rows, minimum 2 workers with harnesses. ABSOLUTE PROHIBITION: NO exposed bare wooden laths/battens! NO skeletal uncovered roof structure!`,
