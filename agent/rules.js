...
const VISUAL_RULES_BY_SERVICE = {
  ...
  'Reparation toiture': `VISUAL: Roofers replacing damaged terracotta roof tiles, flat roof-ladder hooked on ridge, minimum 2 workers (1 on roof with harness, 1 at ground). Tiles being laid must be in smooth, realistic alignment.`,
  'Renovation tuiles toiture': `VISUAL: Worker on a flat roof-ladder hooked at top ridge. Ground extension ladder stops strictly at the gutter edge and NEVER climbs onto the sloping roof surface. Tiles naturally fixed on roof surface.`,
  'Changement tuiles': `VISUAL: Roofers on flat roof-ladder (hooked on top ridge) replacing broken tiles, neatly laid terracotta tiles in clean rows. Minimum 2 workers (1 roof, 1 ground).`,
  'Reparation tuiles': `VISUAL: Roofers on flat roof-ladder (hooked on top ridge) replacing broken tiles, neatly laid terracotta tiles in clean rows. Minimum 2 workers (1 roof, 1 ground).`,
  'Remplacement tuiles': `VISUAL: Roofers replacing broken terracotta roof tiles on slope, replacement tiles laid in realistic parallel rows, minimum 2 workers with harnesses.`,
