...
const VISUAL_RULES_BY_SERVICE = {
  ...
  'Ravalement & nettoyage de façade': `VISUAL: Facade rendering & high-pressure/softwash cleaning (Ravalement & nettoyage de façade). Facade craftsman on certified scaffold or ground level using a pressure lance to clean exterior rendered walls, visible stark contrast between cleaned bright section and unwashed wall, safety goggles, water spray.`,
  'Ravalement et nettoyage de façade': `VISUAL: Facade rendering & high-pressure cleaning. Cleaning exterior rendered house wall with pressure lance from scaffolding.`,
  'Ravalement & nettoyage de facade': `VISUAL: Facade rendering & high-pressure cleaning. Cleaning exterior rendered house wall with pressure lance from scaffolding.`,
  'Ravalement et nettoyage de facade': `VISUAL: Facade rendering & high-pressure cleaning. Cleaning exterior rendered house wall with pressure lance from scaffolding.`,
  'Rénovation de façade & traitement des fissures': `VISUAL: Facade renovation & crack treatment (Rénovation de façade & traitement des fissures). Craftsman scraping damaged wall areas, opening structural cracks, applying fiberglass crack-bridging mesh tape (bande armée) and flexible acrylic/lime repair mortar with spatula/trowel from scaffolding.`,
  'Rénovation de façade et traitement des fissures': `VISUAL: Facade crack repair & renovation. Applying flexible repair mortar and reinforcing mesh on wall cracks from scaffold.`,
  'Renovation de facade & traitement des fissures': `VISUAL: Facade crack repair & renovation. Applying flexible repair mortar and reinforcing mesh on wall cracks from scaffold.`,
  'Renovation de facade et traitement des fissures': `VISUAL: Facade crack repair & renovation. Applying flexible repair mortar and reinforcing mesh on wall cracks from scaffold.`,
  'Enduit de façade': `VISUAL: Exterior facade rendering / plaster application (Enduit de façade). Facade specialist applying fresh hydraulic lime or monocouche render coat on house exterior wall with stainless steel plastering trowel (taloche / platoir), smooth scratched or float finish, scaffolding with guardrail.`,
  'Enduit de facade': `VISUAL: Exterior facade rendering. Specialist applying fresh hydraulic render on house exterior wall with plastering trowel from scaffolding.`,
  'Enduit projeté': `VISUAL: Exterior sprayed render application with render machine nozzle and trowel finishing.`,
  'Enduit taloché': `VISUAL: Exterior float-finish render being smoothed with sponge trowel (taloche éponge) on house wall.`,
  'Peinture de façade': `VISUAL: Exterior facade painting (Peinture de façade). House painter using long-nap exterior paint roller and corner brush applying microporous siloxane/pliolite exterior masonry paint on rendered house wall from scaffolding or ground stepladder, paint bucket and drop cloths along ground.`,
  'Peinture de facade': `VISUAL: Exterior facade painting. House painter applying exterior siloxane paint on rendered wall with long-nap roller from scaffolding.`,
  'Peinture extérieure façade': `VISUAL: Exterior house painting with professional masonry paint roller.`,
  'Traitement façade & humidité': `VISUAL: Waterproofing & anti-damp facade treatment (Traitement façade & humidité). Specialist applying clear waterproofing hydrofuge repellent or anti-saltpetre micro-emulsion on exterior wall base using low-pressure spray lance or heavy roller, moisture meter and injection equipment at foundation base.`,
  'Traitement façade et humidité': `VISUAL: Waterproofing & anti-humidity treatment. Applying clear hydrofuge repellent micro-emulsion on wall with low-pressure lance.`,
  ...
  // ── SITES DÉBARRAS (Services officiels & Types d'interventions) ──
  'Débarras bureaux': `VISUAL: Commercial office clearance (Débarras bureaux). Professional movers in work clothes disassembling and moving office desks, ergonomic chairs, filing cabinets and stacked labeled archive boxes on heavy-duty moving dollies/hand trucks in a bright corporate office space.`,
  'Débarras bureau': `VISUAL: Office furniture and equipment clearance with movers using hand trucks.`,
  'Débarras de bureaux': `VISUAL: Commercial office clearance with movers carrying desks and archive boxes.`,
  'Débarras appartement': `VISUAL: Residential apartment & house clearance (Débarras appartement). Professional clearance team carefully sorting and moving boxed personal belongings, wooden furniture and household items with moving dollies in an apartment living room.`,
  'Débarras d\'appartement': `VISUAL: Apartment clearance with movers carrying furniture and sorted boxes.`,
  'Débarras maison': `VISUAL: Complete house clearance with movers sorting bulky household items and boxes.`,
  'Débarras logement': `VISUAL: Residential property clearance with movers carrying packed items.`,
  'Autres débarras': `VISUAL: General bulky waste and item clearance (Autres débarras). Movers sorting diverse household items, old wooden furniture and stacked moving boxes loaded onto hand trucks.`,
  'Débarras syndrome de Diogène': `VISUAL: Extreme clutter & Diogenes syndrome specialized clearance (Débarras syndrome de Diogène). Professional hygiene technicians wearing white disposable protective coverall suits, FFP3 respirator masks, safety goggles and nitrile gloves carefully sorting and bagging accumulated clutter into heavy-duty waste bags.`,
  'Débarras Diogène': `VISUAL: Specialized deep clearance with technicians in white protective suits and respirator masks.`,
  'Débarras de garage ou box': `VISUAL: Garage & storage box clearance (Débarras de garage ou box). Open garage door with movers sorting old tires, storage boxes, garden tools and metal shelving units onto hand trucks.`,
  'Débarras de garage': `VISUAL: Garage clearance with movers sorting tools, boxes and shelving.`,
  'Débarras garage': `VISUAL: Garage clearance with movers sorting tools, boxes and shelving.`,
  'Débarras box': `VISUAL: Storage box clearance with movers sorting stored belongings.`,
  'Débarras d\'entrepôt': `VISUAL: Warehouse & logistics clearance (Débarras d’entrepôt). Workers operating manual pallet jack (transpalette) clearing wooden Euro-pallets, stacked industrial storage boxes and metal racks in a spacious warehouse.`,
  'Débarras entrepôt': `VISUAL: Warehouse facility clearance with pallet jack and industrial storage racks.`,
  'Débarras entrepot': `VISUAL: Warehouse facility clearance with pallet jack and industrial storage racks.`,
  'Débarras d\'archives': `VISUAL: Document & archives clearance (Débarras d’archives). Clearance team sorting and moving rows of uniform numbered cardboard archive boxes on heavy-duty carts.`,
  'Débarras archives': `VISUAL: Archive and document storage clearance with labeled archive boxes.`,
  'Débarras de chantier': `VISUAL: Construction site cleanup & rubble removal (Débarras de chantier). Workers wearing hard hats, safety boots and heavy work gloves shoveling construction debris, plasterboard scrap and timber offcuts into reinforced rubble sacks and wheelbarrows.`,
  'Débarras chantier': `VISUAL: Construction site waste clearance with workers in safety gear and wheelbarrows.`,
  'Débarras de matériel informatique': `VISUAL: IT equipment & e-waste clearance (Débarras de matériel informatique). Workers carefully packing old computer towers, monitors, server racks and electronic peripherals into palletized transport containers.`,
  'Débarras informatique': `VISUAL: E-waste & computer equipment clearance with palletized containers.`,
  'Débarras de jardin': `VISUAL: Garden & outdoor clearance (Débarras de jardin). Workers loading green waste, old broken garden furniture and dismantled shed panels into heavy-duty garden waste bags.`,
  'Débarras jardin': `VISUAL: Garden clearance with workers sorting outdoor debris and old furniture.`,
  'Débarras de local commercial': `VISUAL: Commercial shop & retail clearance (Débarras de local commercial). Team removing retail display shelves, counters and store fixtures using moving flat carts in an empty store.`,
  'Débarras local commercial': `VISUAL: Retail store clearance with team dismantling display shelving.`,
  'Débarras de combles': `VISUAL: Attic & roof space clearance (Débarras de combles). Movers under wooden attic rafters sorting and moving vintage trunks, old boxed items and insulation scrap down attic stairs.`,
  'Débarras combles': `VISUAL: Attic clearance under timber roof rafters with movers sorting stored boxes.`,
  'Débarras grenier': `VISUAL: Attic clearance under timber roof rafters with movers sorting stored boxes.`,
