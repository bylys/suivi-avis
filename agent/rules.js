...
const VISUAL_RULES_BY_SERVICE = {
  ...
  'Reparation toiture': `VISUAL: Targeted roof tile repair. Roofer on flat roof-ladder (hooked on ridge) replacing 1 or 2 damaged tiles, 1 or 2 tiles lifted showing the spot, spare replacement terracotta tiles sitting nearby in a bucket or on the roof slope. ABSOLUTE PROHIBITION: NO massive skeletal uncovered roof spanning large areas of bare laths!`,
  'Renovation tuiles toiture': `VISUAL: Mostly finished tiled roof with roofer performing tile maintenance along the roof surface or ridge capping.`,
  'Changement tuiles': `VISUAL: Targeted tile replacement. Roofer on roof ladder replacing 1 or 2 broken tiles, spare new terracotta tiles sitting nearby on the tile row or in a roof bucket. ABSOLUTE PROHIBITION: NO massive skeletal uncovered roof spanning large areas of bare laths!`,
  'Reparation tuiles': `VISUAL: Targeted tile repair. Roofer replacing 1 or 2 damaged tiles on a fully tiled roof, spare terracotta tiles sitting next to the roofer in a bucket or on the roof slope. ABSOLUTE PROHIBITION: NO massive skeletal uncovered roof spanning large areas of bare laths!`,
  'Remplacement tuiles': `VISUAL: Targeted tile replacement. Roofer replacing 1 or 2 broken terracotta tiles on slope, new replacement tiles resting safely nearby. ABSOLUTE PROHIBITION: NO massive skeletal uncovered roof spanning large areas of bare laths!`,
