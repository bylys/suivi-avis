...
export const SITE_REALISM_GROS_OEUVRE = {
  terrassement: {
    scenarios: [
      ...
      // --- création allée encours state-lock (must be first — before generic allee|cour|chemin regex) ---
      {
        _for:                             '^creation allee$',
        _state_for:                       'encours',
        _visual_family:                   'TERRASSEMENT-PAVER-DRIVEWAY-INSTALLATION',
        _access_configuration:            'GROUND_LEVEL_PAVER_INSTALLATION',
        _access_configuration_source:     'state_lock',
        _access_configuration_randomized: false,
        planned_worker_count:             1,
        setting:                          'exterior',
        scene_note:    'residential paver driveway installation in progress — rectangular paving blocks being laid by hand in a running or herringbone bond on a prepared sand bed — one section already fully paved, adjacent section still open sand bed — worker crouched or kneeling at the active laying face, placing and tapping a paver with a rubber mallet — alignment cord stretched taut along the laying edge — small stack of pavers beside the worker — residential house visible in background at a safe distance',
        scene_camera:  'standing at the end of the driveway in perspective along its length at slight diagonal — full width visible showing paved section on one side and open sand bed on the other — worker visible at the active laying face in the midground',
        scene_framing: {
          work_pct:   70,
          foreground: 'edge of the laid section — last three or four pavers in position, sand bed visible beside them at the unfinished zone',
          midground:  'worker crouched at the laying face — rubber mallet in hand — alignment cord running along the block edge — small paver stack to the side',
          background: 'house facade or garden wall visible at the far end of the driveway at a safe distance',
        },
        scene_debris:  'sand displaced from the bed at the laying edge — small fragments of cut paver near the trimming zone',
        scene_exclude: [
          'aggregate sub-base only with no paving blocks visible',
          'fully completed paved surface with no active laying',
          'worker sweeping jointing sand across finished paving',
          'concrete being poured or levelled',
          'asphalt being laid or rolled',
          'generic ground levelling or grading with no pavers',
          'utility trench open in the driveway',
          'creation chemin',
          'empierrement',
          'nivellement',
          'preparation terrain',
        ...
        tools: [
          'rubber mallet in worker hand tapping paver into sand bed',
          'alignment cord stretched taut along the laying edge',
          'long spirit level resting on the paved section confirming level',
          'small stack of rectangular pavers beside the worker ready to be laid',
        ],
        protections: [
          'safety cones at the driveway ends marking the work zone',
          'kneeling pad under worker at the laying face',
        ],
        chantier_details: [
          'paved section clearly visible on one side — uniform block bond pattern',
          'open sand bed visible on the unfinished section — flat and level, ready for next pavers',
          'laying edge clearly defined — last course of pavers meeting the open sand bed',
          'alignment cord running parallel to the laying direction',
          'house facade or garden boundary visible in background confirming residential context',
        ],
      },
