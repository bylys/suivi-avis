/**
 * services/carrelage-contracts.js — source canonique des contrats visuels carrelage.
 * Importer depuis ici dans le code de production ; docs/ re-exporte ce fichier.
 * Ne pas dupliquer.
 */
