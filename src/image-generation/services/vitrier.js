  ...
  vitrier: {
    scenarios: [
      ...
      // ── 2. Remplacement double vitrage ───────────────────────────────────────
      {
        ...
        interior_variant: {
          scene_note:   'IGU replacement in an apartment window — thick double-pane unit replaced from inside the apartment. Window frame retained. Camera inside at a slightly oblique angle so no glass panel stands directly between camera and workers. Workers use suction cup handles with cut-resistant gloves. Old fogged or condensation-misted IGU may be visible leaning against the wall.',
          scene_camera: 'standing inside the apartment room at a slightly oblique angle — 2 m back, camera slightly to the side so no glass panel stands directly between camera and workers; workers and IGU visible from a natural working position',
          scene_framing: {
            foreground: 'worker in cut-resistant gloves gripping suction cup handles on the new IGU panel — hands on suction cup grips only, not placed between the camera and the glass surface; padded support block or rubber mat visible under the IGU base near the window sill',
            midground:  'apartment window opening with the IGU being positioned in the frame; slightly oblique camera angle so no glass panel stands directly between the camera and the workers; second worker guiding the frame or applying sealant if visible',
            background: 'interior apartment room — walls, floor, furniture visible; old fogged or condensation-misted IGU leaning against the wall as a preferred optional indicator',
          },
          setting:      'interior',
          location_must_have: [
            ...
            'worker(s) with cut-resistant glazing gloves clearly visible while handling the IGU',
            'suction cup handles used to position or carry the IGU panel',
            'camera angle offset so no glass panel stands directly between the camera and the workers',
          ],
          location_forbidden: [
            ...
            'any hand, arm or suction cup appearing to pass through or merge with the glass surface',
            'glass panel standing as a flat vertical wall directly between camera and workers, making workers appear to be inside or behind the glass',
            'IGU edge as the dominant extreme foreground subject with hands placed on either side of the glass edge facing the camera',
          ],
          tools: [
          ...
          chantier_details: [
            'old IGU leaning against the interior wall — thick double-pane profile visible; condensation or fogging between the two panes preferred as a contextual identifier if shown',
            'new IGU resting on a padded support block or rubber mat near the window sill',
      ...
      // ── 7. Vitrage sécurité feuilleté ────────────────────────────────────────
      {
        ...
        interior_variant: {
          scene_note:   'laminated safety glass replacement in an apartment — the key visual identifier is the old cracked pane: laminated glass breaks in a spider-web fracture pattern where all fragments stay bonded as one piece. Worker removes the intact but shattered pane using suction cups and cut-resistant gloves. No loose shards on the floor. New laminated panel leaning against the wall in background. Camera inside at a slightly oblique angle, not aligned behind the glass.',
          scene_camera: 'standing inside the apartment room — 2 m back, slightly oblique angle showing the cracked laminated pane in or near the window frame; camera not aligned so that the glass stands directly between camera and workers',
          scene_framing: {
            foreground: 'old cracked laminated glass pane — spider-web fracture pattern covering the surface, all fragments still bonded in one piece with no loose shards; worker in heavy-duty glazing gloves gripping suction cup handles on an intact area of the shattered panel',
            midground:  'apartment window opening with the cracked pane being carefully removed as a single unit; suction cups fully engaged; slightly oblique camera angle so no glass surface stands directly between camera and workers',
            background: 'interior apartment room — walls and floor visible, protective sheeting on floor; new laminated panel leaning against the wall nearby',
          },
          setting:      'interior',
          location_must_have: [
            'apartment interior — interior walls and floor visible',
            'cracked laminated glass pane with a spider-web fracture pattern — all fragments bonded in one piece, no loose shards on the floor',
            'worker(s) with heavy-duty cut-resistant glazing gloves clearly visible',
            'suction cups engaged on the cracked pane for safe removal',
            'camera angle offset so no glass surface stands directly between the camera and the workers',
          ],
          location_forbidden: [
            'house exterior facade visible',
            ...
            'loose glass fragments or shards scattered on the floor — laminated glass must stay in one piece',
            'clean uncracked glass being handled without any fracture pattern — visually indistinguishable from any other glazing job',
            'any hand, arm or suction cup appearing to pass through or merge with the glass surface',
            'glass panel as a flat vertical wall directly between camera and workers',
          ],
          tools: [
          ...
          chantier_details: [
            'old cracked laminated glass pane — spider-web fracture pattern, all fragments held together by the PVB film; no loose glass shards on the floor',
            'suction cup handles positioned on an intact area of the cracked pane for safe lifting',
            'drop sheet on the apartment floor below the window to catch any small fragments',
            'new laminated glass panel leaning against the interior wall nearby — uncracked, ready to be installed',
          ],
        },
      },
